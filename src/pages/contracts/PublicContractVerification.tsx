          ...
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div className="min-w-0">
              <Badge className="mb-3 rounded-full bg-slate-950 text-white hover:bg-slate-950">
                Vérification officielle NAYS CAR
              </Badge>
            ...
            <CardContent className="flex flex-col items-center gap-4 p-10 text-center">
              ...
              <div>
                ...
                <p className="mt-2 max-w-md text-sm text-slate-600">
                  Le QR code scanné ne correspond à aucun contrat valide dans le système NAYS CAR.
                </p>
              </div>
            </CardContent>
          </Card>
                ...
                <CardContent className="flex flex-col gap-4 p-4 sm:flex-row sm:items-center sm:justify-between sm:p-5">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-slate-600">Ce document existe dans la base officielle NAYS CAR.</p>
                    </div>
                  </div>
              ...
              <Card className="border-slate-200 bg-white shadow-sm">
                <CardContent className="space-y-3 p-5">
                  <div className="flex items-center justify-between gap-3">
                    ...
                    <span className="text-right text-sm font-semibold">{contract.agencyName || "NAYS CAR"}</span>
                  </div>
                  <div className="flex items-center justify-between gap-3">
