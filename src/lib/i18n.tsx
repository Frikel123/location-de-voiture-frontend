...
const translations: Record<Language, Record<TranslationKey, string>> = {
  fr: {
    ...
    "wa.reserveCar": "Bonjour N1 Lux Cars, je souhaite réserver la {car} ({price} �/jour).",
  ...
  en: {
    ...
    "wa.reserveCar": "Hello N1 Lux Cars, I would like to book the {car} ({price} �/day).",
  ...
  de: {
    ...
    "wa.reserveCar": "Hallo N1 Lux Cars, ich möchte den {car} ({price} �/Tag) buchen.",
