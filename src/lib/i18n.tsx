...
const translations: Record<Language, Record<TranslationKey, string>> = {
  fr: {
    ...
    "hero.badge": "Bienvenue chez NAYS CAR",
    ...
    "contact.city": "NAYS CAR, Fes",
    "contact.whatsapp": "Discuter sur WhatsApp",
    "footer.tagline": "Location de voiture - Fes, Maroc",
    "footer.welcome": "Bienvenue chez NAYS CAR",
    "footer.rights": "Tous droits reserves.",
    "wa.reserve": "Bonjour NAYS CAR, je souhaite reserver une voiture.",
    "wa.reserveCar": "Bonjour NAYS CAR, je souhaite reserver la {car} ({price} DH/jour).",
    "wa.moreInfo": "Bonjour NAYS CAR, je souhaite plus d'informations.",
    "wa.info": "Bonjour NAYS CAR, je souhaite des informations.",
  ...
  en: {
    ...
    "hero.badge": "Welcome to NAYS CAR",
    ...
    "contact.city": "NAYS CAR, Fez",
    "contact.whatsapp": "Chat on WhatsApp",
    "footer.tagline": "Car rental - Fez, Morocco",
    "footer.welcome": "Welcome to NAYS CAR",
    "footer.rights": "All rights reserved.",
    "wa.reserve": "Hello NAYS CAR, I would like to book a car.",
    "wa.reserveCar": "Hello NAYS CAR, I would like to book the {car} ({price} DH/day).",
    "wa.moreInfo": "Hello NAYS CAR, I would like more information.",
    "wa.info": "Hello NAYS CAR, I would like some information.",
