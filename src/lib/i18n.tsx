...
const translations: Record<Language, Record<TranslationKey, string>> = {
  fr: {
    ...
    "hero.badge": "Bienvenue chez N1 Lux Cars",
    ...
    "contact.city": "N1 Lux Cars, Fès",
    "contact.whatsapp": "Discuter sur WhatsApp",
    "footer.tagline": "Location de voiture haut de gamme - Fès, Maroc",
    "footer.welcome": "Bienvenue chez N1 Lux Cars",
    "footer.rights": "Tous droits réservés.",
    "wa.reserve": "Bonjour N1 Lux Cars, je souhaite réserver une voiture.",
    "wa.reserveCar": "Bonjour N1 Lux Cars, je souhaite réserver la {car} ({price} DH/jour).",
    "wa.moreInfo": "Bonjour N1 Lux Cars, je souhaite plus d'informations.",
    "wa.info": "Bonjour N1 Lux Cars, je souhaite des informations.",
  ...
  en: {
    ...
    "hero.badge": "Welcome to N1 Lux Cars",
    ...
    "contact.city": "N1 Lux Cars, Fez",
    "contact.whatsapp": "Chat on WhatsApp",
    "footer.tagline": "Premium car rental - Morocco",
    "footer.welcome": "Welcome to N1 Lux Cars",
    "footer.rights": "All rights reserved.",
    "wa.reserve": "Hello N1 Lux Cars, I would like to book a car.",
    "wa.reserveCar": "Hello N1 Lux Cars, I would like to book the {car} ({price} DH/day).",
    "wa.moreInfo": "Hello N1 Lux Cars, I would like more information.",
    "wa.info": "Hello N1 Lux Cars, I would like some information.",
  ...
  de: {
    ...
    "hero.badge": "Willkommen bei N1 Lux Cars",
    ...
    "contact.address": "Adresse",
    "contact.city": "N1 Lux Cars, Fes",
    "contact.whatsapp": "WhatsApp chatten",
    "footer.tagline": "Premium-Autovermietung - Marokko",
    "footer.welcome": "Willkommen bei N1 Lux Cars",
    "footer.rights": "Alle Rechte vorbehalten.",
    "wa.reserve": "Hallo N1 Lux Cars, ich möchte ein Auto buchen.",
    "wa.reserveCar": "Hallo N1 Lux Cars, ich möchte den {car} ({price} DH/Tag) buchen.",
    "wa.moreInfo": "Hallo N1 Lux Cars, ich möchte mehr Informationen.",
    "wa.info": "Hallo N1 Lux Cars, ich möchte Informationen.",
